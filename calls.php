...
if(empty($phone)) {
    echo "Пожалуйста, заполните номер телефона";
    exit();
}
...
if(mysqli_num_rows($check_result) > 0) {
    ...
    echo "Звонок с таким номером телефона уже зарегистрирован";
    exit();
}
else {

    // Добавляем звонок в базу данных
    $sql = "INSERT INTO calls (phone, created_at, updated_at) VALUES ('$phone', NOW(), NOW())";
